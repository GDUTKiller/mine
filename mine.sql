...
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  `role` TINYINT UNSIGNED NOT NULL COMMENT '管理员角色',
  `province` VARCHAR(10) NOT NULL DEFAULT '', 
  `city` VARCHAR(10) NOT NULL DEFAULT '',
  `create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '账号创建时间',
  `account` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '管理员收款账号', 
  `account_type` VARCHAR(10) NOT NULL DEFAULT '' COMMENT '账号类型，支付宝，中国银行等',
  `deposit` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '已提现金额',
  `status` TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否被封禁',
...
-- 用户允许购买矿车表 
--
CREATE TABLE IF NOT EXISTS `user_allow_car` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` INT UNSIGNED  NOT NULL DEFAULT 0  ,
  `car_0` TIMESTAMP NOT NULL DEFAULT '20380119031407',
  `car_1` TIMESTAMP NOT NULL DEFAULT '20170606060606',
  `car_2` TIMESTAMP NOT NULL DEFAULT '20170606060606',
  `car_3` TIMESTAMP NOT NULL DEFAULT '20170606060606',
  PRIMARY KEY (id)
)ENGINE=InnoDB  AUTO_INCREMENT=1 DEFAULT CHARSET=UTF8
